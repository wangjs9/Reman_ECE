...
tf.app.flags.DEFINE_string('w2v_file', '../reman/w2v_200.txt', 'embedding file')
...
# >>>>>>>>>>>>>>>>>>>> For Data <<<<<<<<<<<<<<<<<<<< #
tf.app.flags.DEFINE_string('train_file_path', '../reman/clause_keywords.csv', 'training file')
